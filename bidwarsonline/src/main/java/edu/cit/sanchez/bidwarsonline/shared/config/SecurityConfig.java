package edu.cit.sanchez.bidwarsonline.shared.config;

import edu.cit.sanchez.bidwarsonline.shared.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/ws-gaming/**").permitAll()
