            ...
            <div className="space-y-3 mb-6 bg-slate-800/50 rounded-lg p-4">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-emerald-400 font-bold text-lg">
                  ₱{(activeSessionData.currentPot || 0).toFixed(2)}
                </span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-slate-400">Win Streak:</span>
                <span className="text-yellow-400 font-semibold">{activeSessionData.streakCount || 0}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-slate-400">Current Card:</span>
                <span className="text-white font-semibold">
                  {activeSessionData.currentCardRank} {getSuitSymbol(activeSessionData.currentCardSuit || "")}
                </span>
              </div>
            </div>
